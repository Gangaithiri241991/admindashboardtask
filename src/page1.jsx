...
import img from "./img/undraw_profile_1.svg"
import img1 from './img/undraw_posting_photo.svg'
import img2 from './img/undraw_rocket.svg'
import img3 from './img/undraw_profile_3.svg'
import img4 from './img/undraw_profile_2.svg'
import img5 from './img/undraw_profile.svg'
    ...
    return(
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item active">
                ...
                <div id="collapseTwo " class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded ">
                        <h6 class="collapse-header active">Custom Components:</h6>
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src={img2} alt="..."/>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow mx-1">
                                ...
                                <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in"
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src={img4}
                                                alt="..."/>
                                    ...
                                    <a class="dropdown-item d-flex align-items-center" href="#">
                                        <div class="dropdown-list-image mr-3">
                                            <img class="rounded-circle" src={img3}
        ...
        <script src="js/sb-admin-2.min.jsx"></script>
